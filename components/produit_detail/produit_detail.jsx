                                            ...
                                            <div className="swiper-wrapper">
                                                <div className="swiper-slide">
                                                    <div className="single-img zoom position-relative">
                                                        ...
                                                        <h2 className="title mb-2 textproduit" >{product.title}</h2>
                                ...
                                <div className="col-lg-12">
                                    <div className="product-detail-tab pt-9">
                                        <ul className="nav nav-pills" id="myTab" role="tablist">
                                            ...
                                            <li className="nav-item" role="presentation">
                                                <a className="nav-link" id="shopping-returns-tab" data-bs-toggle="tab" href="#shopping-returns" role="tab" aria-controls="shopping-returns" aria-selected="false">Domaines </a>
                                            </li>
                                            <li className="nav-item" role="presentation">
                                        ...
                                        <div className="tab-content pt-7" id="myTabContent">
                                            <div className="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                                <div className="description-body">
                                                     <p className="short-desc mb-5" style={{textAlign:'justify'}}>{product.desc}</p>
                                                 </div>
                                            </div>
                                            ...
                                            <div className="tab-pane fade" id="shopping-returns" role="tabpanel" aria-labelledby="shopping-returns-tab">
                                                <div className="shopping-returns-body">
                                                     <p className="shopping-desc mb-5"style={{textAlign:'justify'}}>{product.domaine}</p>
                                                 </div>
                                            </div>
                                            <div className="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
                                                <div className="review-body">
                                                    <div className="blog-feedback-area">
                                                        <h2 className="blog-feedback-title mb-1">Add a review</h2>
                                                        <p className="blog-feedback-desc mb-3">Your email address will not be published.</p>
                                                        <div className="rating-box d-flex">
                                                            <span>Your rating</span>
                                                            <ul className="text-primary ps-6">
                                                        ...
                                                        <form className="blog-feedback-form pt-8" action="#">
                                                            <div className="group-input">
                                                                <div className="form-field me-md-6 mb-6 mb-md-0">
                                                                    <input type="text" name="name" id="name" placeholder="Your name" className="input-field border-secondary border-opacity-50" />
                                                                </div>
                                                                <div className="form-field mb-6 mb-md-0">
                                                                    <input type="text" name="email" id="email" placeholder="Your Email" className="input-field border-secondary border-opacity-50" />
                                                                </div>
                                                            </div>
                                                            <div className="form-field mb-6">
                                                                <input type="text" name="title" id="title" placeholder="Review title" className="input-field border-secondary border-opacity-50" />
                                                            </div>
                                                            <div className="form-field mb-6">
                                                                <textarea name="message" id="message" placeholder="Message" className="textarea-field border-secondary border-opacity-50"></textarea>
                                                            </div>
